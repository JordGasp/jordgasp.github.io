...
import WorkflowViewer from "../../../components/WorkflowViewer.astro";
...
<WorkflowViewer src='/workflows/TG-Auto/Auto-Relaunch.json' height='300px' />
...
<WorkflowViewer src='/workflows/TG-Auto/Orchestrator.json' height='300px' />

- Health check with exponential retry (up to 5 attempts)
- SSH Docker restart on failure
- Batches channels and dispatches processing

**WF2 - Sync Medias Library**

<WorkflowViewer
	src='/workflows/TG-Auto/Sync-Medias-Library.json'
	height='300px'
/>
...
<WorkflowViewer src='/workflows/TG-Auto/Process-Channel.json' height='300px' />
